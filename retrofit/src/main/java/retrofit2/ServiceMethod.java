...
final class ServiceMethod<T> {
    ...
    /**
     * 通过 方法的 参数 生成Request 对象 okhttpclient  生成 realcall
     * RealCall realcall = new OkhttpClient().newCall(request);
    ...
    static final class Builder<T> {
        ...
        public ServiceMethod build() {
            ...
            // 如果没有 body 则不允许 是 流请求和form 表单请求
            if (!hasBody) {
                if (isMultipart) {
                    throw methodError(
    ...
    /**
     * /repos/{owner}/{repo}/contributors   返回   owner、repo
